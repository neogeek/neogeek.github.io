...
<Header
  ...
  subtitle='With the release of Unity 2018.3, the Unity Package Manager finally supports custom packages using git URLs! There are just a few things needed to get a repo setup to be compatible with the package manager.'
/>

Published on <time>February 1st, 2019</time>
...
![](/images/creating-custom-packages-for-unity/assembly-definition-file.png)
...
![](/images/creating-custom-packages-for-unity/git-release.png)
...
![](/images/creating-custom-packages-for-unity/package-manager.png)
