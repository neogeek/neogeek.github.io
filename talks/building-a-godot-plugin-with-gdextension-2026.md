---
title: Building a Godot Plugin with GDExtension (2026)
...
<a href="#1" name="1">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-1.jpg" />
</a>

<a href="#2" name="2">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-2.jpg" />
</a>

<a href="#3" name="3">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-3.jpg" />
</a>

<a href="#4" name="4">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-4.jpg" />
</a>

<a href="#5" name="5">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-5.jpg" />
</a>

<a href="#6" name="6">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-6.jpg" />
</a>

<a href="#7" name="7">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-7.jpg" />
</a>
...
<a href="#8" name="8">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-8.jpg" />
</a>
...
<a href="#9" name="9">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-9.jpg" />
</a>
...
<a href="#10" name="10">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-10.jpg" />
</a>

<a href="#11" name="11">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-11.jpg" />
</a>
...
<a href="#12" name="12">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-12.jpg" />
</a>
...
<a href="#13" name="13">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-13.jpg" />
</a>
...
1. Create `GodotCppPlugin.gdextension` with the following contents:
   ...
   web.debug.wasm32 = "res://addons/GodotCppPlugin/libGodotCppPlugin.web.template_debug.wasm32.nothreads.wasm"
   web.release.wasm32 = "res://addons/GodotCppPlugin/libGodotCppPlugin.web.template_release.wasm32.nothreads.wasm"
   web.debug.threads.wasm32 = "res://addons/GodotCppPlugin/libGodotCppPlugin.web.template_debug.wasm32.wasm"
   web.release.threads.wasm32 = "res://addons/GodotCppPlugin/libGodotCppPlugin.web.template_release.wasm32.wasm"
   ```
...
<a href="#14" name="14">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-14.jpg" />
</a>
...
<a href="#15" name="15">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-15.jpg" />
</a>
...
<a href="#16" name="16">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-16.jpg" />
</a>
...
<a href="#17" name="17">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-17.jpg" />
</a>
...
<a href="#18" name="18">
  <img src="/images/talks/building-a-godot-plugin-with-gdextension-2026/slide-18.jpg" />
</a>
   ...
   jobs:
     build-plugin:
       ...
       steps:
         ...
         - if: matrix.os == 'ubuntu-latest' && matrix.platform == 'web'
           uses: HandcrankEngine/install-emscripten-package@8213812e8b148042942fc3c92d787ccfa823dcfc # v0.1.0
           with:
         ...
         - name: Store Scons Flag as HASH
           shell: bash
           run: |
             echo "SCONS_FLAGS_HASH=$(echo -n "${{ matrix.scons-flags || 'default' }}" | shasum -a 256 | cut -d ' ' -f 1)" >> $GITHUB_ENV
         ...
         - name: SCons Cache
           ...
           with:
             ...
             key: ${{ matrix.platform }}-${{ matrix.arch }}${{ matrix.scons-flags && format('-{0}', env.SCONS_FLAGS_HASH) || '' }}-scons-cache-${{ hashFiles('GodotPlugin/godot-cpp/**/*.cpp', 'GodotPlugin/godot-cpp/**/*.h') }}
             restore-keys: ${{ matrix.platform }}-${{ matrix.arch }}${{ matrix.scons-flags && format('-{0}', env.SCONS_FLAGS_HASH) || '' }}-scons-cache-

         - name: Build Plugin
           working-directory: GodotPlugin/
           shell: bash
           run: |
             scons platform=${{ matrix.platform }} target=template_release arch=${{ matrix.arch }} ${{ matrix.scons-flags }} --debug=explain
             scons platform=${{ matrix.platform }} target=template_debug arch=${{ matrix.arch }} ${{ matrix.scons-flags }} --debug=explain

         - name: Upload build artifacts
           uses: actions/upload-artifact@bbbca2ddaa5d8feaa63e36b76fdaad77386f024f # v7.0.0
           with:
             name: build-${{ matrix.platform }}-${{ matrix.arch }}${{ matrix.scons-flags && format('-{0}', env.SCONS_FLAGS_HASH) || '' }}
...
1. If you have an Apple Developer account and plan on supporting macOS platforms with your plugin, the following addition to the GitHub Workflow will automatically sign the generated files. Place this before the `commit-changes` job and then update the `commit-changes` needs property to include `sign-and-notarize`.
...
- [Slides from this talk (PDF)](</images/talks/building-a-godot-plugin-with-gdextension-2026/Building%20a%20Godot%20Plugin%20with%20GDExtension%20(2026).pdf>)

<script src="/js/slides.js"></script>

<!--
magick -density 200 Building\ a\ Godot\ Plugin\ with\ GDExtension\ \(2026\).pdf -quality 100 -crop 100%x100%-0-1 +repage -scene 1 slide.jpg
-->
